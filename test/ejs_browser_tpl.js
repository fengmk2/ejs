...
var fixtures = ##REPLACE_HOLDER##;

function fixture(name) {
  return fixtures[name].replace(/\r/g, '');
}
...
describe.skip('ejs.renderFile(path, options, fn)', function(){
...
describe('exceptions', function(){
  ...
  it('should not include __stack if compileDebug is false', function(done) {
    try {
...
describe.skip('includes', function(){
